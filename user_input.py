...
def get_user_input():
    ...
    # Solicitamos el nombre o código IATA de la ciudad de destino
    user_data['destination'] = input("¿A qué ciudad quieres viajar? Ejemplo: Paris=CDG o Barcelona=BCN ").upper()
